...
var tiScore=true;
var startTime;
var colorBack="#FFFDFD"; colorButton="#91962F"; colorText="#000000"; colorSele="#487CB7";
...
var words=["UkVRVUlTSVRPUw","SU1QTEVNRU5UQUNJ004","UFJVRUJBUw","REVTQVJST0xMTw","U09QT1JURQ","RElTRdFP","","","",""];imaW=["bd1.jpg","","","","","","","","",""];queW=["PRUEBA","","","","","","","","",""];
var auW=["MQ","","","","","","","","",""];
var fillLetter="ABCDEFGHIJKLMNÑOPQRSTUVWXYZÁÉÍÓÚÜ "; wordsG=[]; indexG=0; actMaxWidth=550; indexWord=0; totalWord=0;
var imageW=[];questionW=[];audioW=[];profG=0; dirMedia="AHORCADO_resources/media/"; textBNext="AHORCADO";
